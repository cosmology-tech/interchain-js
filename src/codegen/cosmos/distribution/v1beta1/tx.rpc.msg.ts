...
export class MsgClientImpl implements Msg {
  ...
  setWithdrawAddress = async (request: MsgSetWithdrawAddress): Promise<MsgSetWithdrawAddressResponseSDKType> => {
  ...
  withdrawDelegatorReward = async (request: MsgWithdrawDelegatorReward): Promise<MsgWithdrawDelegatorRewardResponseSDKType> => {
  ...
  withdrawValidatorCommission = async (request: MsgWithdrawValidatorCommission): Promise<MsgWithdrawValidatorCommissionResponseSDKType> => {
  ...
  fundCommunityPool = async (request: MsgFundCommunityPool): Promise<MsgFundCommunityPoolResponseSDKType> => {
