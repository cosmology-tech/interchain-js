...
export class QueryClientImpl implements Query {
  ...
  allowance = async (request: QueryAllowanceRequest): Promise<QueryAllowanceResponseSDKType> => {
  ...
  allowances = async (request: QueryAllowancesRequest): Promise<QueryAllowancesResponseSDKType> => {
  ...
  allowancesByGranter = async (request: QueryAllowancesByGranterRequest): Promise<QueryAllowancesByGranterResponseSDKType> => {
