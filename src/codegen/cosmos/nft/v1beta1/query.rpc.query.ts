...
export class QueryClientImpl implements Query {
  ...
  owner = async (request: QueryOwnerRequest): Promise<QueryOwnerResponseSDKType> => {
  ...
  supply = async (request: QuerySupplyRequest): Promise<QuerySupplyResponseSDKType> => {
  ...
  nFTs = async (request: QueryNFTsRequest): Promise<QueryNFTsResponseSDKType> => {
  ...
  nFT = async (request: QueryNFTRequest): Promise<QueryNFTResponseSDKType> => {
  ...
  class = async (request: QueryClassRequest): Promise<QueryClassResponseSDKType> => {
