...
export class QueryClientImpl implements Query {
  ...
  grants = async (request: QueryGrantsRequest): Promise<QueryGrantsResponseSDKType> => {
  ...
  granterGrants = async (request: QueryGranterGrantsRequest): Promise<QueryGranterGrantsResponseSDKType> => {
  ...
  granteeGrants = async (request: QueryGranteeGrantsRequest): Promise<QueryGranteeGrantsResponseSDKType> => {
