...
export class QueryClientImpl implements Query {
  ...
  currentPlan = async (request: QueryCurrentPlanRequest = {}): Promise<QueryCurrentPlanResponseSDKType> => {
  ...
  appliedPlan = async (request: QueryAppliedPlanRequest): Promise<QueryAppliedPlanResponseSDKType> => {
  ...
  moduleVersions = async (request: QueryModuleVersionsRequest): Promise<QueryModuleVersionsResponseSDKType> => {
  ...
  authority = async (request: QueryAuthorityRequest = {}): Promise<QueryAuthorityResponseSDKType> => {
