...
export class QueryClientImpl implements Query {
  ...
  validators = async (request: QueryValidatorsRequest): Promise<QueryValidatorsResponseSDKType> => {
  ...
  validator = async (request: QueryValidatorRequest): Promise<QueryValidatorResponseSDKType> => {
  ...
  validatorDelegations = async (request: QueryValidatorDelegationsRequest): Promise<QueryValidatorDelegationsResponseSDKType> => {
  ...
  validatorUnbondingDelegations = async (request: QueryValidatorUnbondingDelegationsRequest): Promise<QueryValidatorUnbondingDelegationsResponseSDKType> => {
  ...
  delegation = async (request: QueryDelegationRequest): Promise<QueryDelegationResponseSDKType> => {
  ...
  unbondingDelegation = async (request: QueryUnbondingDelegationRequest): Promise<QueryUnbondingDelegationResponseSDKType> => {
  ...
  delegatorDelegations = async (request: QueryDelegatorDelegationsRequest): Promise<QueryDelegatorDelegationsResponseSDKType> => {
  ...
  delegatorUnbondingDelegations = async (request: QueryDelegatorUnbondingDelegationsRequest): Promise<QueryDelegatorUnbondingDelegationsResponseSDKType> => {
  ...
  redelegations = async (request: QueryRedelegationsRequest): Promise<QueryRedelegationsResponseSDKType> => {
  ...
  delegatorValidator = async (request: QueryDelegatorValidatorRequest): Promise<QueryDelegatorValidatorResponseSDKType> => {
  ...
  historicalInfo = async (request: QueryHistoricalInfoRequest): Promise<QueryHistoricalInfoResponseSDKType> => {
  ...
  pool = async (request: QueryPoolRequest = {}): Promise<QueryPoolResponseSDKType> => {
