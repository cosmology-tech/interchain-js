...
export class MsgClientImpl implements Msg {
  ...
  grant = async (request: MsgGrant): Promise<MsgGrantResponseSDKType> => {
  ...
  exec = async (request: MsgExec): Promise<MsgExecResponseSDKType> => {
  ...
  revoke = async (request: MsgRevoke): Promise<MsgRevokeResponseSDKType> => {
